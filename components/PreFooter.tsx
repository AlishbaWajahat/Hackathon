...
function PreFooter(){
  return (
    <>
    <div className='font-poppin flex max-w-[2000px] sm:h-[300px] h-auto sm:p-14 py-8 px-8 sm:px-16 xl:px-32 sm:flex-nowrap flex-wrap sm:gap-8 gap-4 bg-[#FAF4F4] items-center justify-center'>
        <div>
