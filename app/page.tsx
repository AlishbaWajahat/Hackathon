...
export default function Home() {
  return (
    <>
      {/* hero section */}
      <div className="bg-[#FBEBB5] max-w-[2000px] "><Header/></div>
      <div className="lg:h-[800px] md:h-[600px] h-auto bg-[#FBEBB5] max-w-[2000px] flex justify-center items-center font-poppin lg:gap-12 gap-8 md:flex-row flex-col-reverse pt-8 pb-8 md:pt-0 md:pb-0 md:px-10">
      ...
      {/* 1st section */}
      <div className="max-w-[2000px] h-auto py-4 px-8 flex gap-4   items-center justify-around font-poppin">
      ...
      <div className="font-poppin flex flex-col items-center py-10 md:mt-14 mt-8 max-w-[2000px]">
        ...
        <div className="flex gap-6 justify-center w-full flex-wrap py-6  mt-8 md:mt-14">
          <Card2 ImageUrl="/pic1(2nd sec).png" text="Trenton modular sofa_3" id={1} />
          <Card2 ImageUrl="/pic2 (2nd sec).png" text="Granite dining table with dining chair" id={2} />
          <Card2 ImageUrl="/pic3(2nd sec) (2).png" text="Outdoor bar table and stool" id={3} />
          <Card2 ImageUrl="/pic4(2nd sec).png" text="plain console with teak mirror" id={4} />
        </div>
      ...
      {/* 3rd section */}
      <div className="max-w-[2000px] bg-[#FBEBB5]  flex font-poppin items-center md:gap-20 lg:gap-28 gap-16 sm:pt-12 pt-8 justify-center md:flex-row flex-col-reverse">
      ...
      {/* 4th section */}
      <div className="font-poppin flex flex-col items-center py-14 max-w-[2000px]">
      ...
      {/* 5th section */}
      <div className="font-poppin max-w-[2000px] sm:h-[300px] h-[200px] md:h-[450px] lg:mb-20 flex justify-center items-center relative">
